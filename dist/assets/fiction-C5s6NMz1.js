import{i as h,a as r}from"./shared-CvNkAlsk.js";h();const d=document.querySelector("#app"),o=document.createElement("main");o.className="container";o.innerHTML=`
...
`;d.appendChild(o);const l={1:{title:"Chapter 1",content:`<p>LUCKY'S GHOSTS (Copyright 2025)</p>
  <p>Chapter 1 -----------</p>
    <p>Plop!</p>
    ...
    <p>The last thing I remember was the sight of a bullet coming at my face – I think I really saw it! – and my head getting knocked back under the water. Then the sound of the gun registered, and everything went black.</p>`},2:{title:"Chapter 2: The Care Center",content:`<p>The hospital at New Babbage is really pretty fancy.They call it a “Care Center,” but I’m old and traditional in some ways, so I think of it as a hospital.Whatever.That’s where I came back to consciousness.</p>
      ...
      <p>I knew Meeka and their empath ways well enough to know if it felt true to them, it was probably true.</p>`},3:{title:"Chapter 3: The Message",content:`<p><em>Bzzzt</em>. My mobi vibrated on my wrist.Glancing at it, I got a pit in my stomach when I saw there was a video message from a woman with green hair.</p>
      ...
      <p>I turned around to see Salty licking a half-eaten ice cream cone and holding two others in his left hand.</p>`}},e=document.querySelector("#reader-modal"),p=document.querySelector("#chapter-body"),a=document.querySelector(".close-modal");document.querySelectorAll(".chapter-link").forEach(t=>{t.addEventListener("click",i=>{const s=i.target.dataset.chapter,n=l[s];p.innerHTML=`<h2>${n.title}</h2>${n.content}`,e.classList.add("active")})});a==null||a.addEventListener("click",()=>e.classList.remove("active"));window.addEventListener("click",t=>{t.target===e&&e.classList.remove("active")});r();
